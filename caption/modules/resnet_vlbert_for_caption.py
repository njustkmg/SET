...
class ResNetVLBERTForCaption(CapModule):
    ...
    def forward(self,
        ...
        with torch.no_grad():
            ...
            vl_out, pooled_rep, extended_attention_mask, object_attention_mask, embedding_output = self.vlbert(tag_input_ids,
                                                                    tag_token_type_ids,
        ...
        dec_output = self.decoder(text, vl_out, object_attention_mask)
    ...
    def beam_search(self,
                    ...
                    max_len=200, eos_idx=100, beam_size=5, out_size=1,
        ...
        # 这里有问题，embedding_output是包含了视觉和文本的特征，是否应该只是用视觉特征
        return bs.apply(embedding_output, vl_out, object_attention_mask, out_size, return_probs, **kwargs)
